# Generated by Django 4.1.3 on 2022-12-05 09:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('children', models.ManyToManyField(blank=True, related_name='children', to='members.memberaddon')),
                ('coshopper', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='coshoppers', to='members.memberaddon')),
                ('groups', models.ManyToManyField(blank=True, related_name='groups', to='members.membergroup')),
                ('groups_interested', models.ManyToManyField(blank=True, related_name='groups_interested', to='members.membergroup')),
                ('membership_card', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.membercard')),
                ('membership_status', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='members.memberstatus')),
                ('skills', models.ManyToManyField(blank=True, to='members.memberskill')),
                ('tags', models.ManyToManyField(blank=True, to='members.membertag')),
            ],
        ),
    ]
