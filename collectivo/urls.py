...
from collectivo.members.urls import urlpatterns as members_url_patterns
...
urlpatterns = [
    ...
    path('api/members/v1/members/schema',
         SpectacularAPIView.as_view(
            patterns=[members_url_patterns[0]]
         ), name='reduced-api-schema'),
    path('api/docs/',
