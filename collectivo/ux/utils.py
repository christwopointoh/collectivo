...
def register_microfrontend(name, **kwargs):
    ...
    return request(
        views.MicroFrontendViewSet, 'create', {'name': name, **kwargs})


def register_menu(name, **kwargs):
    """Register an internal microfrontend."""
    return request(views.MenuViewSet, 'create', {'name': name, **kwargs})


def register_menuitem(name, **kwargs):
    """Register an internal microfrontend."""
    return request(views.MenuItemViewSet, 'create', {'name': name, **kwargs})
